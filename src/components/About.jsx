            ...
            <div className="container">
                <div className="about-grid">
                    ...
                    <div className="about-text">
                        ...
                        <p>At Devnanda Dental Clinic, we believe that a healthy smile is the foundation of a happy life. Led by Dr. Pritam, our team of dedicated professionals uses the latest technology to provide comfortable and effective treatments.</p>
